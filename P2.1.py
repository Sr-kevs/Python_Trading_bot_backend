...
def on_close(ws):
    ...
    time.sleep(60)
    subprocess.run ([sys.executable,'filepath/P2.1.py'] ) 
    sys.exit()       
...
def on_message(ws, message):
    ...
    #    if (d[conf]) > 15:
    #        subprocess.run ( [sys.executable, 'filepath/P2.1.py' ] ) and sys.exit()
    ...
    if close:
        ...
        if not check_wb ==True:
            subprocess.run ([sys.executable,'filepath/P1.3.py'] ) 
            sys.exit()
        ...
        if len(closes):
            ...
            if last_closed > dsup10  :
                ...
                #subprocess.run ([sys.executable, 'filepath/P3.py' ] ) 
                sys.exit()
        ...
        if len(closes):
            ...
            if last_closed < dsup01:
                ...
                subprocess.run ([sys.executable, 'filepath/sellupmarket2.py' ] ) 
                sys.exit()
