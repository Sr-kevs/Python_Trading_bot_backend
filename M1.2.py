...
def on_close(ws):
    ...
    time.sleep(60)
    subprocess.run ([sys.executable,'filepath/M1.2.py'] ) 
    sys.exit()    
...
def on_message(ws, message):
    ...
    #    if (d[conf]) > 15:
    #        subprocess.run ( [sys.executable, 'filepath/M1.2.py' ] ) and sys.exit()
