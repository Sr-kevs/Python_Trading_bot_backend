...
def on_close(ws):
    ...
    time.sleep(60)
    subprocess.run ([sys.executable,'filepath/P1.2.py'] ) 
    sys.exit()       
...
def on_message(ws, message):
    ...
    #        print(" Last wallet value of UP token {}".format(  math.floor (wallet_value4 ) ) )
    ...
    if close:
        ...
        if len(closes):
            ...
            #For 1% up in FuturesBot3, sell sushidown
