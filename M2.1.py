...
#percentages up or down from entry price
dsup100 = wb1.loc[4, 'C']
dsup99 = wb1.loc[5, 'C']
dsup98 = wb1.loc[6, 'C']
dsup97 = wb1.loc[7, 'C']
...
dsupm96 = wb1.loc[200, 'C']
dsupm97 = wb1.loc[201, 'C']
dsupm98 = wb1.loc[202, 'C']
dsupm99 = wb1.loc[203, 'C']

print("This entry point {}".format(dsup00))



#trade quantity in SUSHIUP 
#coins_sushiup_1 = 1/5
#coins_sushiup_2 = 1/10
#coins_sushiup_3 = 1/3
...
#trade quantity SUSHIDOWN
#coins_sushudown_1 = 1/5
#coins_sushudown_2 = 1/10
#coins_sushudown_3 = 1/3
...
TRADE_SYMBOL = str(wb1.loc[4, 'I'])

ORDER_STATUS_FILLED = 'FILLED'
ORDER_TYPE = ORDER_TYPE_MARKET
#To run on the binance API
...
client = Client("zd78kY21dGVZZ3uh4XeKSBGaTX8NybnulU4WQ32ZLRW8nu08cU73oCbwGPoPYney", "e6J6gkjTYx1ZMrzf6hCAciDqORAPfTwNMM97QZ8XUptuERB8xM8WrkNXyoYgVank")
...
def on_close(ws):
    ...
    time.sleep(60)
    subprocess.run ([sys.executable,'C:/Users/kevin/Documents/Inversion/Bit trading/FuturesBot3/M2.1.py'] ) 
    sys.exit()    
...
def on_message(ws, message):
    ...
    #
    #if is_candle_closed:
    #    print("Is candle closed?? {}".format(conf))
    #    confs.append(float(conf))
    #    d = (Counter(confs))
    #    print("It have passed {} minutes".format (d[conf]))
    #    if (d[conf]) > 15:
    #        subprocess.run ( [sys.executable, 'C:/Users/kevin/Documents/Inversion/Bit trading/FuturesBot3/M2.1.py' ] ) and sys.exit()
    ...
    if close:
        ...
        if len(closes):
            ...
            #for selling -2% down in FuturesBot3, sell 1/10 sushidown
            if last_closed < dsupm16 :
                order = client.futures_create_order(
                    symbol= TRADE_SYMBOL,
                    side=SIDE_BUY,
                    positionSide = short,
                    type =  ORDER_TYPE_MARKET,
                    quantity= round( ( (amount_future_contracts_short*-1) /5))
                    )
                print(order)  
                #playsound('C:/Users/kevin/Documents/Inversion/Bit trading/FuturesBot3/cashingmachine.mp3')
                #subprocess.run ([sys.executable, 'C:/Users/kevin/Documents/Inversion/Bit trading/FuturesBot3/M3.py' ] ) 
                sys.exit()
        ...
        if len(closes):
            last_closed = closes[-1]
            #for selling -1% down in FuturesBot3, sell sushiup
            if last_closed > dsup00:
                if in_position:
                    print("Reached 2 percent this code is not needed no more")
                    subprocess.run ([sys.executable, 'C:/Users/kevin/Documents/Inversion/Bit trading/FuturesBot3/M1.3.py' ] ) and sys.exit()
                           
                else:
                    print("Conditions not met for selling at 2 percent dowm")
