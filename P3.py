...
SOCKET = "wss://fstream.binance.com/ws/lrcusdt_perpetual@continuousKline_1m"
    ...
    if close:
        ...
        if len(closes):
            ...
            if last_closed > dsup14  :
                ...
                print (order )                 
                #subprocess.run ([sys.executable,'filepath/P4.py' ] )
                sys.exit()
        ...
        if len(closes):
            ...
            if last_closed < dsup05  :
                #last_closed > dsup10   :
                if in_position:
                    print("Sold all up token @ 2 percent up")                
